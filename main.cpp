...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Truckcoin-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.truckcoin.net", "node1.truckcoin.net", "node2.truckcoin.net", "node3.truckcoin.net", ""};
